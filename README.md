...
### 👑 인생 '날로 먹기'를 꿈꾸기 때문에 목표를 이룰때까지 **매일 1커밋(토,일빼고!!!!)**을 목표로 힘내보겠습니다!!!.
...
## 1. 제조 현장 최적화 ERP 시스템: 맥주 생산 공정 관리 (React Project)

- 소개: React 기반 맥주 제조 공정(생산계획~출하) 관리 ERP 개발. LOT 기반 10단계 공정 데이터 연동 및 상태 시각화 구현.
